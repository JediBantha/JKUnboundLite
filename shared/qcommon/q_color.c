...
vec4_t colorTable[CT_MAX] =
{
	...
	{	.278f,	.784f,	.573f,	.75f},	// CT_ICON_GREEN
	{	.567f,	.685f,	1.0f,	.75f},	// CT_ICON_BLUE
	
	{	0.7f,	0.9f,	1.0f,	.75f},	// CT_FORCE_LIGHT
	{	1.0f,	0.5f,	0.5f,	.75f},	// CT_FORCE_DARK

	{	1.0f,	0.8f,	0.35f,	1},	// CT_AMMO_DEFAULT
	{	1.0f,	0.35f,	0.35f,	1},	// CT_AMMO_BLASTER
	{	1.0f,	0.65f,	0.35f,	1},	// CT_AMMO_DISRUPTOR
	{	0.35f,	1.0f,	0.35f,	1},	// CT_AMMO_BOWCASTER
	{	0.35f,	0.5f,	1.0f,	1},	// CT_AMMO_DEMP2
	{	0.8f,	0.35f,	1.0f,	1},	// CT_AMMO_CONCUSSION
