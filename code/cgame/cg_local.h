...
typedef struct {
	...
	int			healthHUDTotalFlashTime;
	int			healthHUDNextFlashTime;
	qboolean	healthHUDActive;

	int			armorHUDTotalFlashTime;
	int			armorHUDNextFlashTime;
	qboolean	armorHUDActive;
...
#define MAX_SHOWPOWERS (NUM_FORCE_POWERS - 4)
...
#define MAX_DPSHOWPOWERS NUM_FORCE_POWERS
...
extern	vmCvar_t		cg_drawShieldWarning;
