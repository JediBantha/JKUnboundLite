...
//Chunks
	...
	qhandle_t	forceCoronaLightShader;
	qhandle_t	forceCoronaSaberShader;
	qhandle_t	forceCoronaDarkShader;
	...
	qhandle_t	electricBodyShaderRed;
	qhandle_t	electricBody2ShaderRed;
	qhandle_t	refractShader;
	qhandle_t	boltShader;
	qhandle_t	boltShaderRed;
	...
	qhandle_t	DPLightForcePowerOverlay;
	qhandle_t	DPSaberForcePowerOverlay;
	qhandle_t	DPDarkForcePowerOverlay;
...
typedef struct
{
	...
	fxHandle_t	forceLightningWideRed;
