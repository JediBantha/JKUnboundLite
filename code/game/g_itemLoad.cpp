...
static void IT_Name(const char **holdBuf)
{
	...
	else if (!Q_stricmp(tokenStr,"ITM_FORCE_SABERDEFEND_PICKUP"))
	{
		itemNum = ITM_FORCE_SABERDEFEND_PICKUP;
	}
	else if (!Q_stricmp(tokenStr,"ITM_FORCE_SABERATTACK_PICKUP"))
	{
		itemNum = ITM_FORCE_SABERATTACK_PICKUP;
	}
	else if (!Q_stricmp(tokenStr,"ITM_FORCE_RAGE_PICKUP"))
	{
		itemNum = ITM_FORCE_RAGE_PICKUP;
	}
	else if (!Q_stricmp(tokenStr,"ITM_FORCE_PROTECT_PICKUP"))
	{
		itemNum = ITM_FORCE_PROTECT_PICKUP;
	}
	else if (!Q_stricmp(tokenStr,"ITM_FORCE_ABSORB_PICKUP"))
	{
		itemNum = ITM_FORCE_ABSORB_PICKUP;
	}
	else if (!Q_stricmp(tokenStr,"ITM_FORCE_DRAIN_PICKUP"))
	{
		itemNum = ITM_FORCE_DRAIN_PICKUP;
	}
	else if (!Q_stricmp(tokenStr,"ITM_FORCE_SIGHT_PICKUP"))
	{
		itemNum = ITM_FORCE_SIGHT_PICKUP;
	}
	...
	else if (!Q_stricmp(tokenStr,"ITM_JETPACK_PICKUP"))
		itemNum = ITM_JETPACK_PICKUP;
	else if (!Q_stricmp(tokenStr,"ITM_CLOAK_PICKUP"))
		itemNum = ITM_CLOAK_PICKUP;
	else if (!Q_stricmp(tokenStr,"ITM_FORCE_GEM_PICKUP"))
		itemNum = ITM_FORCE_GEM_PICKUP;
...
static void IT_Tag(const char **holdBuf)
{
	...
	else if (!Q_stricmp(tokenStr,"FP_SABER_DEFENSE"))
	{
		tag = FP_SABER_DEFENSE;
	}
	else if (!Q_stricmp(tokenStr,"FP_SABER_OFFENSE"))
	{
		tag = FP_SABER_OFFENSE;
	}
	else if (!Q_stricmp(tokenStr,"FP_RAGE"))
	{
		tag = FP_RAGE;
	}
	else if (!Q_stricmp(tokenStr,"FP_PROTECT"))
	{
		tag = FP_PROTECT;
	}
	else if (!Q_stricmp(tokenStr,"FP_ABSORB"))
	{
		tag = FP_ABSORB;
	}
	else if (!Q_stricmp(tokenStr,"FP_DRAIN"))
	{
		tag = FP_DRAIN;
	}
	else if (!Q_stricmp(tokenStr,"FP_SEE"))
	{
		tag = FP_SEE;
	}
	else if (!Q_stricmp(tokenStr,"ITM_BATTERY_PICKUP"))
	...
	else if (!Q_stricmp(tokenStr,"INV_FORCE_GEM"))
	{
		tag = INV_FORCE_GEM;
	}
