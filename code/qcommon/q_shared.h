...
#define MAX_AMMO				10
#define MAX_INVENTORY			18		// See INV_MAX	(INV_GOODIE_KEY+10)
...
public:
	...
	int			forcePowerDamageDebounce[NUM_FORCE_POWERS];
	int			forcePowerCostDebounce[NUM_FORCE_POWERS];
	int			forcePower;
	int			forcePowerMax;
		...
		ojk::SavedGameHelper& saved_game) const
	{
		...
		saved_game.write<int32_t>(forcePowerDamageDebounce);
		saved_game.write<int32_t>(forcePowerCostDebounce);
		...
		saved_game.write<int32_t>(jetpackFuel);
		saved_game.write<int32_t>(cloakFuel);
#endif // !JK2_MODE
	}
		...
		ojk::SavedGameHelper& saved_game)
	{
		...
		saved_game.read<int32_t>(forcePowerDamageDebounce);
		saved_game.read<int32_t>(forcePowerCostDebounce);
		...
		saved_game.read<int32_t>(jetpackFuel);
		saved_game.read<int32_t>(cloakFuel);
#endif // !JK2_MODE
	}
}; // PlayerStateBase
